...
## copied code to have data to practice ##
...
## Q1 change the column labeled name in bands to Band Name ##
...
## Q3 get all the bands that have albums ##
...
## Q4 get all the bands that have no albums ##
...
LIMIT 1;
 ...
 ## Q6 upate the release year of the album with no release year ##

SELECT * FROM record_company.albums;
 ## this query is used to see which albums release year was null ##
 
UPDATE albums
SET release_year = 1986
WHERE id = 4;

 ## Q7 insert record of my favorite band and their album ##
 
 INSERT INTO bands (name)
VALUES ('Summer Walker');

## this query is used to get the band id of the band just added ##
  SELECT id FROM bands
  ORDER BY id DESC LIMIT 1;

INSERT INTO albums (name, release_year, band_id)
VALUES ('Still Over It', 2021, 8);
 
 ## Q8 delete the band and album added in Q7 ##
...
WHERE band_id = 8;
 ...
 ## Q9 get the average length of all songs ##
 
SELECT AVG(length) as 'Average Song Duration'
FROM songs;

 ## Q10 select longest song from each album
...
GROUP BY s.album_id;
 ...
 ## Q11 get the number of songs from each band
...
## THIS IS PRACTICE PROBLEMS DESIGNED BY WEBDEVSIMPLIFIED ##